              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="inputadmin.php">
                    ...
                    <div class="form-group">
                      <label for="alamat">PASWORD</label>
                      <input type="text" class="form-control" name="PASWORD" placeholder="masukan nama">
                    </div>
                    <div class="form-group">
                      <label for="alamat">TELP</label>
                      <input type="text" class="form-control" name="TELP" placeholder="masukan nama">
                    </div>
